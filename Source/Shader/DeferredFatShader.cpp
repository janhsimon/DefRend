...
#include "DeferredFatShader.hpp"
#include "..\Light\PointLight.hpp"
#include "..\Light\SpotLight.hpp"
#include "..\Util\Error.hpp"

// vertex shader uniform names
const std::string DeferredFatShader::WORLD_MATRIX_UNIFORM_NAME = "worldMatrix";
const std::string DeferredFatShader::VIEW_MATRIX_UNIFORM_NAME = "viewMatrix";
const std::string DeferredFatShader::PROJECTION_MATRIX_UNIFORM_NAME = "projectionMatrix";
const std::string DeferredFatShader::EYE_POSITION_UNIFORM_NAME = "eyePosition";

// fragment shader uniform names
const std::string DeferredFatShader::GBUFFER_MAPS_UNIFORM_NAMES[4] = { "inGBufferMRT0", "inGBufferMRT1", "inGBufferMRT2", "inGBufferMRT3" };
const std::string DeferredFatShader::SHADOW_MAP_UNIFORM_NAME = "inShadowMap";
const std::string DeferredFatShader::SCREEN_SIZE_UNIFORM_NAME = "screenSize";
const std::string DeferredFatShader::LIGHT_TYPE_UNIFORM_NAME = "light.type";
const std::string DeferredFatShader::LIGHT_POSITION_UNIFORM_NAME = "light.position";
const std::string DeferredFatShader::LIGHT_DIRECTION_UNIFORM_NAME = "light.direction";
const std::string DeferredFatShader::LIGHT_DIFFUSE_COLOR_UNIFORM_NAME = "light.diffuseColor";
const std::string DeferredFatShader::LIGHT_DIFFUSE_INTENSITY_UNIFORM_NAME = "light.diffuseIntensity";
const std::string DeferredFatShader::LIGHT_SPECULAR_INTENSITY_UNIFORM_NAME = "light.specularIntensity";
const std::string DeferredFatShader::LIGHT_SPECULAR_POWER_UNIFORM_NAME = "light.specularPower";
const std::string DeferredFatShader::LIGHT_CAST_SHADOWS_UNIFORM_NAME = "light.castShadows";
const std::string DeferredFatShader::LIGHT_SHADOW_BIAS_UNIFORM_NAME = "light.shadowBias";
const std::string DeferredFatShader::LIGHT_CUTOFF_COSINE_UNIFORM_NAME = "light.cutoffCosine";

bool DeferredFatShader::create()
{
	if (!load("Shaders\\Deferred.vs.glsl", "", "Shaders\\DeferredFat.fs.glsl"))
		return false;
	...
	{
		Error::report("Error", "Failed to load fat deferred shader: " + Error::getOpenGLErrorString(error));
		return false;
	}
...
void DeferredFatShader::setWorldViewProjectionUniforms(const glm::mat4 &worldMatrix, const glm::mat4 &viewMatrix, const glm::mat4 &projectionMatrix)
{
...
void DeferredFatShader::setEyePositionUniform(const glm::vec3 &eyePosition)
{
	glUniform3f(eyePositionUniformLocation, eyePosition.x, eyePosition.y, eyePosition.z);
}

void DeferredFatShader::setScreenSizeUniform(unsigned int screenWidth, unsigned int screenHeight)
{
	glUniform2f(screenSizeUniformLocation, (float)screenWidth, (float)screenHeight);
}

void DeferredFatShader::setLightParameterUniforms(const DirectionalLight &light)
{
