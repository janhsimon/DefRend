...
#include "DeferredSlimShader.hpp"
#include "..\Light\PointLight.hpp"
#include "..\Light\SpotLight.hpp"
#include "..\Util\Error.hpp"

// vertex shader uniform names
const std::string DeferredSlimShader::WORLD_MATRIX_UNIFORM_NAME = "worldMatrix";
const std::string DeferredSlimShader::VIEW_MATRIX_UNIFORM_NAME = "viewMatrix";
const std::string DeferredSlimShader::PROJECTION_MATRIX_UNIFORM_NAME = "projectionMatrix";
const std::string DeferredSlimShader::EYE_POSITION_UNIFORM_NAME = "eyePosition";

// fragment shader uniform names
const std::string DeferredSlimShader::GBUFFER_MAPS_UNIFORM_NAMES[2] = { "inGBufferMRT0", "inGBufferMRT1" };
const std::string DeferredSlimShader::SHADOW_MAP_UNIFORM_NAME = "inShadowMap";
const std::string DeferredSlimShader::SCREEN_SIZE_UNIFORM_NAME = "screenSize";
const std::string DeferredSlimShader::LIGHT_TYPE_UNIFORM_NAME = "light.type";
const std::string DeferredSlimShader::LIGHT_POSITION_UNIFORM_NAME = "light.position";
const std::string DeferredSlimShader::LIGHT_DIRECTION_UNIFORM_NAME = "light.direction";
const std::string DeferredSlimShader::LIGHT_DIFFUSE_COLOR_UNIFORM_NAME = "light.diffuseColor";
const std::string DeferredSlimShader::LIGHT_DIFFUSE_INTENSITY_UNIFORM_NAME = "light.diffuseIntensity";
const std::string DeferredSlimShader::LIGHT_SPECULAR_INTENSITY_UNIFORM_NAME = "light.specularIntensity";
const std::string DeferredSlimShader::LIGHT_SPECULAR_POWER_UNIFORM_NAME = "light.specularPower";
const std::string DeferredSlimShader::LIGHT_CAST_SHADOWS_UNIFORM_NAME = "light.castShadows";
const std::string DeferredSlimShader::LIGHT_SHADOW_BIAS_UNIFORM_NAME = "light.shadowBias";
const std::string DeferredSlimShader::LIGHT_CUTOFF_COSINE_UNIFORM_NAME = "light.cutoffCosine";

bool DeferredSlimShader::create()
{
	if (!load("Shaders\\Deferred.vs.glsl", "", "Shaders\\DeferredSlim.fs.glsl"))
		return false;
...
void DeferredSlimShader::setWorldViewProjectionUniforms(const glm::mat4 &worldMatrix, const glm::mat4 &viewMatrix, const glm::mat4 &projectionMatrix)
{
...
void DeferredSlimShader::setEyePositionUniform(const glm::vec3 &eyePosition)
{
	glUniform3f(eyePositionUniformLocation, eyePosition.x, eyePosition.y, eyePosition.z);
}

void DeferredSlimShader::setScreenSizeUniform(unsigned int screenWidth, unsigned int screenHeight)
{
	glUniform2f(screenSizeUniformLocation, (float)screenWidth, (float)screenHeight);
}

void DeferredSlimShader::setLightParameterUniforms(const DirectionalLight &light)
{
